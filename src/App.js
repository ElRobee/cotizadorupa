    ...
    <div className="flex-1 p-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Gestiona tus cotizaciones</p>
        </div>
        <button
          onClick={() => {
            setModalType('quotation');
            ...
            <tbody>
              {getFilteredQuotations().map(quotation => (
                <tr key={quotation.id} className="border-t border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-700">{formatDate(quotation.date)}</td>
                  <td className="py-4 px-6 font-medium text-gray-900">${quotation.total.toLocaleString()}</td>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="text-left py-4 px-6 text-sm font-medium text-gray-600">Teléfono</th>
            ...
            <tbody>
              {getFilteredClients().map(client => (
                <tr key={client.id} className="border-t border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-700">{client.telefono}</td>
                  <td className="py-4 px-6 text-gray-700">{client.ciudad}</td>
                  <td className="py-4 px-6">
                    <div className="flex items-center space-x-2">
                      <button
